...
data<- read.csv("F:/그림/190107_2016-2018 도시평균.csv")
head(data)

library(plyr)
data1 <-ddply(data, ~YYYY+MM+DD, summarize, mean_PM10<-mean(PM10))

data1$date <- paste0(data1$YYYY,"-",data1$MM,"-",data1$DD)
data1$date <-as.Date(data1$date)
head(data1)

calendarHeat(data1$date, values=data1$..1, varname="daily average PM10", color = "g2r")
